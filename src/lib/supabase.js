...
/* ---- auth helpers ---- */
export const auth = {
  signUp: (email, password, fullName, captchaToken) => supabase.auth.signUp({
    email, password,
    options: { data: { full_name: fullName, accepted_terms_at: new Date().toISOString(), terms_version: "1.0" }, captchaToken: captchaToken || undefined, emailRedirectTo: `${window.location.origin}/?verified=1` }
  }),
